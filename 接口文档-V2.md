 ...
 - 接口
             ...
             var settings = {
               ...
               "headers": {
                 ...
                 "cache-control": "no-cache",
                 "postman-token": "d3961c7d-0012-ae34-6587-b51d35f0c67d",
                 "content-type": "application/x-www-form-urlencoded"
               },
               "data": {
                 "type": "110",
...
### 报警图片上传
            ...
            var settings = {
              "async": true,
              "crossDomain": true,
              "url": "http://api.i-vectors.com:10666/api/alarm/uploadimage",
              "method": "POST",
              "headers": {
                ...
                "cache-control": "no-cache",
                "postman-token": "09b52669-5ec2-eb57-74ed-12703d73fcb5"
              },
              "processData": false,
              "contentType": false,
              "mimeType": "multipart/form-data",
...
### 报警视频上传
                ...
                var settings = {
                  "async": true,
                  "crossDomain": true,
                  "url": "http://api.i-vectors.com:10666/api/alarm/uploadvideo",
                  "method": "POST",
                  "headers": {
                    "oauthorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOjEsImlzcyI6Imh0dHA6XC9cL2FwaS5pLXZlY3RvcnMuY29tOjEwNjY2XC9hcGlcL3VzZXJcL2xvZ2luIiwiaWF0IjoxNDU5NTE4NTc1LCJleHAiOjE0NTk1MjIxNzUsIm5iZiI6MTQ1OTUxODU3NSwianRpIjoiOTk3Y2IyMDIwYjJlY2ExOTkwY2ZkMTZlZGM5ZDBjNzIifQ.RgFY9NaTMkWuVMSjtHM3JdEtQapOHoe8HPc625biXGA",
                    "authorization": "Bearer eEkt3x8iOoMOiuriRI3b7ZglUmJ55OWyajYlh6a6",
